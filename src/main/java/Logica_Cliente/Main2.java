...
public class Main2 {
    ...
    public static void main(String[] args) {
        ...
        Helpers.HelperImpresion.ImprimirInfoFigura(objCuadrado);
        Helpers.HelperImpresion.ImprimirInfoFigura(objCirculo);
        Helpers.HelperImpresion.ImprimirInfoFigura(objTriangulo);
